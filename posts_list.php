<?php include './include/template/header.php';
  ...
  echo implode(" | ",$post_results);
    ...
    $postvote = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM posts JOIN makepost ON posts.pid = makepost.pid WHERE makepost.ssid = '$subs'"));
    //echo implode(" | ",$postvote);
    $totalvote = $postvote['upvote'] - $postvote['downvote'];
    //echo implode(" | ", $row);
